...
public final class XMLLookParser2 {
	 ...
	 */
	public XMLLookParser2(final String xml, final SignatureField field, final Properties p, final PrivateKeyEntry pke) {
		this.xml = xml;
		this.image = null;
		this.prop = p;
		this.field = field;
	...
	public XMLLookParser2(final String xml, final Properties p) {
		this.xml = xml;
		this.image = null;
		this.prop = p;
		this.field = null;
